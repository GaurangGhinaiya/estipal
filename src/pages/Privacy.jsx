...
const Privacy = () => {
  return (
    <div className="bg-[#f9fafc]">
      <div class="Privacy_Policy max-w-[100%] xl:max-w-[60%] mx-[20px] xl:mx-auto max-sm:max-w-[90%]">
        <h1 className="!text-3xl sm:!text-4xl font-semibold">
          Website Privacy Policy
        </h1>

        <p>Last modified: 01 June 2022</p>
        ...
        <p>
          Estipal LLC (<strong>"Company" </strong>or <strong>"We"</strong>)
        ...
        <p>
          ...
          or that you may provide when you visit the website estipal.com or the
          EstiPal application (downloaded from any application “store”) and
          EstiPal website at: estipal.com (collectively, our "
        ...
        <ul>
          <li>On this Website (including on the EstiPal application).</li>
          <li>
          ...
          <li>
            When you interact with any other sources that are implemented
            through or by this Website, from time to time.
          </li>
        </ul>
        ...
        <p>
          ...
          Website or through any of its features, make any purchases through the
        ...
        <ul>
          ...
          <li>
            ...
            the details of your internet service provider; and/or
          </li>
          <li>
        ...
        <p>
          The information we collect on or through our Website may include, but
          be not limited to:
        </p>
        ...
        <p>
          ...
          online services (behavioral tracking). Contact us for information on
        ...
        <p>
          ...
          you do not want us to use your information in this way, please contact
          us at{" "}
          <a href="mailto:admin@estipal.com" style={{ color: "#3c8dbc" }}>
            admin@estipal.com
          </a>
        ...
        <ul>
          ...
          <li>
            ...
            transfer of some or all of Estipal LLC's assets, whether as a going
            concern or as part of bankruptcy, liquidation, or similar
            proceeding, in which personal information held by Estipal LLC about
        ...
        <ul>
          ...
          <li>
            ...
            rights, property, or safety of Estipal LLC, our customers, or
        ...
        <ul>
          ...
          <li>
            ...
            you can opt-out by contacting us at{" "}
            <a href="mailto:admin@estipal.com" style={{ color: "#3c8dbc" }}>
              admin@estipal.com
            </a>
            .
          ...
          <li>
            ...
            wish to have your email address/contact information used by the
            Company to promote our own or third parties' products or services,
            you can opt-out by contacting us at{" "}
            <a href="mailto:admin@estipal.com" style={{ color: "#3c8dbc" }}>
              admin@estipal.com
            </a>
          ...
          <li>
            ...
            preferences, you can opt-out by contacting us at{" "}
            <a href="mailto:admin@estipal.com" style={{ color: "#3c8dbc" }}>
              admin@estipal.com
            </a>
            .
        ...
        <p>
          We have implemented measures we deemed to be sufficient to secure your
