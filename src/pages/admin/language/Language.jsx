...
const Language = () => {
  ...
  return (
    <div className="mx-auto px-[15px] sm:px-[45px] py-[20px] min-h-[100vh]">
      {isLoading && (
      ...
      <>
        ...
        <div className="relative w-full">
          ...
          {isOpen && (
            <ul className="absolute w-full  bg-[#1e252b]  shadow-lg max-h-60 overflow-y-auto border border-gray-700 rounded-b-md">
