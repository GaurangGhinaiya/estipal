                ...
                <table className="table-auto w-full text-left">
                    <thead style={{ borderBottom: "2px solid #111111" }}>
                        <tr>
                            ...
                            <th class="p-2 text-[#ffff] text-center cursor-pointer">Total Completed deal</th>
                            <th class="p-2 text-[#ffff] text-center cursor-pointer">Total Bought</th>
                            <th class="p-2 text-[#ffff] text-center cursor-pointer">Total Sold</th>
                            <th class="p-2 text-[#ffff] text-center cursor-pointer">
                                Total Profit
                            </th>
                            <th class="p-2 text-[#ffff] text-center cursor-pointer">
