...
export const ModalCollection = ({
  ...
  useEffect(() => {
    if (iSEditCollectionData?.model_no) {
      setInputValue(iSEditCollectionData?.model_no);
    }
  }, [iSEditCollectionData?.model_no, isModalVisibleCollection]);
      ...
      <div className="bg-[#283641] text-white p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button
            onClick={async () => {
              setLoading(true);
              await handleCollectionSubmit(inputValue);
              setLoading(false);
            }}
